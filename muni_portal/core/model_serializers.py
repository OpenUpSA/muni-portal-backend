...
class ServiceRequestSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance: ServiceRequest, validated_data: ServiceRequestObject):
        ...
        instance.user_mobile_number = validated_data.get(
            "F4", instance.user_mobile_number
        )
        instance.user_email_address = validated_data.get(
            "F5", instance.user_email_address
        )
        instance.municipal_account_number = validated_data.get(
            "F6", instance.municipal_account_number
        )
        ...
        instance.on_premis_reference = validated_data.get(
            "F14", instance.on_premis_reference
        )
        instance.collaborator_status = validated_data.get(
            "F15", instance.collaborator_status
        ).lower()
